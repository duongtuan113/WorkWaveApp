...
// // Import các models và controllers cần thiết
...
//   }
//
//   // --- LOGIC TẢI VÀ KẾT HỢP DỮ LIỆU (Không đổi) ---
...
//
//     await Future.wait([
//       userStoryCtrl.loadAllStories(project.projectId, token),
...
//       child: Row(
//         children: [
//           _buildScrollableHeaderCell('PRIORITI', width: 120),
...
//           SizedBox(
//               width: 120, child: Center(child: _buildAssigneeAvatar(assignee))),
//         ],
//       ),
//     );
//   }
...
//       default:
//         // Nếu không có priority, trả về một widget trống để giữ bố cục
...
//   }
//
//   Widget _buildAssigneeAvatar(String? name) {
//     if (name == null || name.isEmpty || name.toLowerCase() == 'unassigned') {
