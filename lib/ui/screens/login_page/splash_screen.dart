// // lib/ui/screens/login_page/splash_screen.dart (Đây là file duy nhất chứa SplashScreen)
//
...
//   bool _isLoadingAuth = true; // Ban đầu hiển thị loading khi kiểm tra token
//   //
//   // @override
//   // void initState() {
//   //   super.initState();
...
//     authController.initialized.then((_) {
//       if (authController.isLoggedInStatus) {
...
//   //
//   //   try {
//   //     print('SplashScreen: Waiting for AuthController to initialize...');
//   //     await auth.initialized;
//   //
//   //     print('SplashScreen: AuthController initialized. Checking token...');
//   //     bool hasValidToken = await auth.refreshAccessToken();
//   //
//   //     if (!mounted) return;
//   //
//   //     if (hasValidToken) {
//   //       print('SplashScreen: Token valid, navigating to home.');
//   //       context.go('/');
//   //     } else {
//   //       print('SplashScreen: Token invalid or expired, showing login UI.');
//   //       setState(() {
//   //         _isLoadingAuth = false; // CHỖ QUAN TRỌNG NÀY
//   //       });
//   //     }
//   //   } catch (e) {
