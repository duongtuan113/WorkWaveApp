...
//   final String projectId; // thêm biến này
//
...
//     return Scaffold(
//       backgroundColor: Colors.grey[100], // Màu nền nhẹ hơn
//       appBar: AppBar(
//         backgroundColor: Colors.grey[100], // Đồng bộ màu với Scaffold
//         title: const Text("NHOM4 board",
//             style: TextStyle(fontWeight: FontWeight.bold)),
//         leading: const Icon(Icons.arrow_back),
//         actions: const [Icon(Icons.more_vert)],
//         bottom: ProjectTabBar(selectedIndex: 2, projectId: projectId),
//         scrolledUnderElevation: 0, // Giữ màu không đổi khi cuộn
//       ),
//       body: ListView(
//         padding: const EdgeInsets.all(16),
//         children: [
//           SprintWidget(
//             title: 'NHOM4 Sprint 1',
//             workItems: [
//               WorkItem(
//                   title: 'Thiết kế giao diện bằng Figma',
//                   code: 'NHOM4-1',
//                   assignee: 'H',
//                   color: Colors.orange),
//               WorkItem(
...
//                   color: Colors.orange),
//               WorkItem(
//                   title: 'Chọn kiến trúc cho dự án',
//                   code: 'NHOM4-2',
//                   assignee: 'LD',
//                   color: Colors.teal),
//             ],
...
//
//   const SprintWidget({required this.title, required this.workItems, super.key});
//
//   @override
...
//   late List<WorkItem> _items;
//
//   @override
//   void initState() {
//     super.initState();
//     _items = List.from(widget.workItems);
//   }
//
//   void _toggleInput() {
//     setState(() {
...
//   }
//
//   void _addWorkItem(String title) {
//     if (title.trim().isEmpty) return;
//     setState(() {
//       _items.add(
//         WorkItem(
//           title: title,
//           code: 'NEW-${_items.length + 1}',
//           assignee: '',
//           color: Colors.orange,
//         ),
//       );
//       _controller.clear();
//       showInput = false; // Ẩn TextField khi đã thêm công việc
//     });
//   }
//
//   @override
...
//       leading: Icon(isBug ? Icons.bug_report : Icons.check_box,
