...
//       {super.key, required this.storyId, required this.projectId});
//
//   @override
...
//     await userController.loadProjectMembers(widget.projectId);
//
...
//
//       final userIds = {
//         if (story.createdBy != null) story.createdBy!,
//         if (story.updatedBy != null) story.updatedBy!,
//         if (story.assignedTo != null) story.assignedTo!,
//       };
//
//       for (final id in userIds) {
//         await userController.fetchUserByIdOnce(id);
//       }
...
//               onPressed: () => context.pop(), // ✅ GoRouter safe pop
//             ),
...
//                       assignedTo: _selectedAssignedTo ?? const Object(),
//                       priorityId: _selectedPriorityId ?? const Object(),
//                       sprintId: _selectedSprintId ?? const Object(),
//                       epicId: _selectedEpicId ?? const Object(),
//                     );
//
//                     final success =
...
//                                 ? _selectedAssignedTo
//                                 : null,
//                             items: userCtrl.projectMembers.map((user) {
...
//             onChanged: onChanged,
//             validator: (val) => null,
//             dropdownColor: Colors.white, // ✅ Thêm dòng này để nền menu trắng
//             decoration: InputDecoration(
//               filled: true,
