...
// //   final double barHeight = 60.0; // tăng kích thước bug
...
// //       orElse: () => projectCtrl.selectedProject ?? projectCtrl.projects.first,
// //     );
// //
...
// //       appBar: AppBar(
// //         title: Text(project.name, style: const TextStyle(color: Colors.black)),
// //         backgroundColor: Colors.white,
// //         elevation: 0.5,
// //         iconTheme: const IconThemeData(color: Colors.black),
// //         bottom: ProjectTabBar(selectedIndex: 4, projectId: widget.projectId),
// //       ),
...
// //       {required this.bug, required this.width, required this.height});
// //
// //   final Bug bug;
// //   final double width;
// //   final double height;
...
//     Future.microtask(() async {
//       await context.read<BugController>().loadBug(widget.projectId);
//       await context.read<SprintController>().loadSprints(widget.projectId);
//       _scrollToToday();
//     });
//   }
//
...
//                               color: Colors.grey),
//                       onTap: () {
//                         controller.selectSprint(
//                             sprint); // ✅ cập nhật SprintController
...
//                     children: [
//                       Text(
//                         sprintCtrl.selectedSprint?.name ?? 'Select Sprint',
//                         style: const TextStyle(
//                           fontSize: 18,
//                           fontWeight: FontWeight.bold,
//                           color: Colors.black,
